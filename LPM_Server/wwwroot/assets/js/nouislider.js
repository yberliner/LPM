(function () {
    ...
    /* primary1 colored slider */
    var sliderPrimaryColored = document.getElementById('primary1-colored-slider');
    noUiSlider.create(sliderPrimaryColored, {
        start: [50],
        step: 1,
        connect: [true, false],
    ...
    /* primary2 colored slider */
    var sliderPrimaryColored = document.getElementById('primary2-colored-slider');
    noUiSlider.create(sliderPrimaryColored, {
        start: [50],
        step: 1,
        connect: [true, false],
    ...
    /* primary3 colored slider */
    var sliderPrimaryColored = document.getElementById('primary3-colored-slider');
    noUiSlider.create(sliderPrimaryColored, {
        start: [50],
        step: 1,
        connect: [true, false],
